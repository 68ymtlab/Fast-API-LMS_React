...
import { AlertCircle, CheckCircle, Plus, Edit, Trash2, Eye, Megaphone } from "lucide-react";
...
const formSchema = z.object({
  ...
  content: z.string().min(1, "本文を入力してください").max(5000, "本文は5000文字以内で入力してください"),
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <Badge variant={getUserKindBadgeVariant(announcement.user_kind_id)}>
                              {formatUserKind(announcement.user_kind_id)}
                            </Badge>
                          </div>
                          <div className="text-sm text-gray-600 space-y-1">
                            <div>表示期間: {formatDate(announcement.start_date_time)} ～ {formatDate(announcement.end_date_time)}</div>
                            <div>送信日時: {formatDate(announcement.send_date_time)}</div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="お知らせのタイトルを入力" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
          ...
          {selectedAnnouncement && (
            <div className="space-y-4">
              <div>
                ...
                <p className="mt-1">
                  {formatDate(selectedAnnouncement.start_date_time)} ～ {formatDate(selectedAnnouncement.end_date_time)}
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <Badge variant={getUserKindBadgeVariant(selectedAnnouncement.user_kind_id)} className="mt-1">

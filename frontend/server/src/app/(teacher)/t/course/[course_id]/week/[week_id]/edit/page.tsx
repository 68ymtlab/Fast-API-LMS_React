...
import { Edit, BookOpen, PlayCircle, AlertCircle } from "lucide-react";
        ...
        <CardContent>
          ...
          <Tabs defaultValue="week_info" className="w-full">
            <TabsList className="grid w-full grid-cols-3">
              <TabsTrigger value="week_info" className="flex items-center gap-2">
                <BookOpen className="h-4 w-4" />
                詳細編集
              </TabsTrigger>
              <TabsTrigger value="week_content" className="flex items-center gap-2">
                <BookOpen className="h-4 w-4" />
                教科書コンテンツ編集
              </TabsTrigger>
              <TabsTrigger value="flow_content" className="flex items-center gap-2">

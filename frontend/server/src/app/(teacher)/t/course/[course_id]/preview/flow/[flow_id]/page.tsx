...
import { AlertCircle, Play, Eye, ArrowLeft, Clock, Target, CheckCircle } from "lucide-react";
          ...
          {flowInfo && (
            <div className="space-y-8">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        <Badge variant="outline">問題 {flowInfo.flow_order}</Badge>
                        <Badge variant="secondary" className="flex items-center gap-1">
                          <Clock className="h-3 w-3" />
                          約{flowInfo.estimated_time}分
                        </Badge>
                        <Badge>{flowInfo.session_count}個のセッション</Badge>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      <Link href={`/t/course/${params.course_id}/week/${flowInfo.week_id}/edit`}>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 whitespace-pre-wrap">{flowInfo.flow_detail}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  {flowSessions.length === 0 ? (
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-500">セッションが登録されていません</p>
                    </div>
                  ) : (
                    <div className="grid gap-4">
                      {flowSessions.map((session) => (
                        <Card key={session.flow_session_id} className={`border-l-4 border-l-blue-500`}>
                            ...
                            <div className="flex items-start justify-between">
                              <div className="flex-1">
                                <div className="flex items-center gap-3 mb-2">
                                  ...
                                  <div className={`flex items-center gap-1 px-2 py-1 rounded text-xs text-white ${getSessionTypeColor(session.session_type)}`}>
                              ...
                              <div className="flex flex-col gap-2 ml-4">
                                <Link href={`/t/course/${params.course_id}/preview/flow/${params.flow_id}/session/${session.flow_session_id}/1`}>
              ...
              <div className="flex justify-center gap-4">
                <Link href={`/course/${params.course_id}/flow/${params.flow_id}`}>

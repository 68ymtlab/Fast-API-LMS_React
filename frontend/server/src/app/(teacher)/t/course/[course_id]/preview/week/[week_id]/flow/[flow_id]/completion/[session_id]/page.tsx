...
import { AlertCircle, CheckCircle, Trophy, ArrowLeft, RotateCcw, Eye, GraduationCap } from "lucide-react";
    ...
    <div className="container mx-auto py-8 px-4 max-w-4xl">
      ...
      {loading ? (
        ...
        <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div className="text-center">
                    ...
                    <Badge variant={getAccuracyBadgeVariant(completionData?.accuracy_rate || 85)} className="text-sm">
                      正答率
                    </Badge>
                  </div>
                  
                  <div className="text-center text-sm text-gray-600">
                    {completionData?.correct_answers || 8} / {completionData?.total_questions || 10} 問正解
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-gray-700">
                      {getPerformanceMessage(completionData?.accuracy_rate || 85)}
                    </p>
                  </div>
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-gray-700">
                      セッション #{completionData?.session_number || 1} (プレビュー)
                    </p>
                  </div>
                </div>
              </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg text-blue-700">学生向けアクション (プレビュー)</CardTitle>
              <CardDescription>実際の学生画面では以下のボタンが表示されます</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-gray-50 border-gray-200">
            <CardContent className="pt-6">
              <div className="text-center">
                <h3 className="font-medium mb-2 text-gray-700">プレビュー情報</h3>
                <p className="text-sm text-gray-600 mb-4">
                  この画面は学生が演習を完了した際に表示されるものと同じ内容です。<br />
                  実際の成績データは学生のセッション結果に基づいて表示されます。
                </p>
                <div className="text-xs text-gray-500 bg-white p-3 rounded border">
                  <strong>注意:</strong> プレビューモードでは実際のセッションデータではなく、<br />

...
import { AlertCircle, BookOpen, Play, ArrowLeft, Clock, CheckCircle, RotateCcw, Eye, GraduationCap, Settings } from "lucide-react";
...
function TeacherFlowPreviewPage() {
  ...
  const startPreviewSession = async () => {
    try {
      ...
      router.push(`/t/course/${params.course_id}/preview/week/${params.week_id}/flow/${params.flow_id}/session/${flowSessionId}/1`);
    } catch (error) {
  ...
  const goToFlowEdit = () => {
    router.push(`/t/course/${params.course_id}/week/${params.week_id}/flow/${params.flow_id}/edit`);
  };

  const previewCompletion = () => {
    // Navigate to completion preview with a mock session ID
    router.push(`/t/course/${params.course_id}/preview/week/${params.week_id}/flow/${params.flow_id}/completion/preview`);
  };
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-6xl">
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <Button variant="outline" onClick={returnToWeekPreview} className="flex items-center gap-2">
                  <ArrowLeft className="h-4 w-4" />
                  週プレビューに戻る
                </Button>
                <Button variant="secondary" onClick={goToFlowEdit} className="flex items-center gap-2">
          ...
          <div className="lg:col-span-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>学生に表示される内容のプレビュー</CardDescription>
              </CardHeader>
              <CardContent>
                ...
                <div className="space-y-4">
                  <div className="text-center">
                    <h4 className="font-medium mb-4 text-blue-700">学生向けアクション (プレビュー)</h4>
                    <Button 
      ...
      <Card className="mt-6 bg-blue-50 border-blue-200">
        <CardHeader>
          <CardTitle className="text-lg text-blue-700">教師向けアクション</CardTitle>
        </CardHeader>
        <CardContent>

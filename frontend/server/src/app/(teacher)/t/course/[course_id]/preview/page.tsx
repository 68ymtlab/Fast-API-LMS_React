...
import { AlertCircle, BookOpen, Calendar, Clock, Play, Eye, ArrowLeft } from "lucide-react";
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="prose prose-sm max-w-none">
                        <p className="text-gray-700 whitespace-pre-wrap">{courseInfo.course_detail}</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent>
                  {weeks.length === 0 ? (
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-500">まだ週次コンテンツが登録されていません</p>
                    </div>
                  ) : (
                    <div className="grid gap-4">
                      {weeks.map((week) => (
                        <Card key={week.week_id} className="border-l-4 border-l-blue-500">
                          <CardContent className="p-4">
                            <div className="flex items-start justify-between">
                              <div className="flex-1">
                                <div className="flex items-center gap-3 mb-2">
                                  <Badge variant="outline">第{week.week_num}週</Badge>
                                  <h4 className="font-semibold text-lg">{week.week_name}</h4>
                                </div>
                              ...
                              <div className="flex flex-col gap-2 ml-4">
                                <Link href={`/t/course/${params.course_id}/preview/week/${week.week_id}/1`}>
                                  <Button size="sm" variant="outline" className="flex items-center gap-2">
                                    <Eye className="h-4 w-4" />
                                    プレビュー
                                  </Button>
                                </Link>
                                <Link href={`/t/course/${params.course_id}/week/${week.week_id}/edit`}>

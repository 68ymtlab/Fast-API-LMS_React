    ...
    try {
      const response = await axios.post(
        "/create_course",
        {
          ...
          start_date_time: `${startDate}T${startTime}:00`,
          end_date_time: `${endDate}T${endTime}:00`,
          weeks: weeks,
        },
        { withCredentials: true },
      );
      ...
      <CardContent className="p-4 space-y-3">
        ...
        <div className="flex items-center gap-3 bg-white/80 rounded-xl p-3 shadow-inner">
          ...
          <span className="text-sm text-neutral-700 font-medium">
            最終アクセス: {course.last_accessed ? new Date(course.last_accessed).toLocaleString("ja-JP") : "準備中"}
          </span>
        </div>
      </CardContent>
      <CardFooter className="p-4 pt-0">
        <div className="w-full flex gap-3">
          ...
          <Button
            ...
            onClick={() =>
              handleButtonClick(`status-${course.course_id}`, () => router.push(`/t/course/${course.course_id}/score`))
            }
            ...
            <DialogContent className="sm:max-w-[600px]">
              ...
              <form onSubmit={handleCreateCourse}>
                <div className="grid gap-6 py-6">
                  <div className="grid gap-4">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      ...
                      <div className="grid gap-2">
                        <Label htmlFor="end-time" className="text-base font-medium">
                          終了時間
                        </Label>
                        <Input
                          id="end-time"
                ...
                <DialogFooter className="gap-3">
                  ...
                  <Button type="submit" disabled={isCreating} className="h-12 text-base bg-primary hover:bg-primary/90">
                    {isCreating ? "作成中..." : "作成"}
                  </Button>
                </DialogFooter>
              </form>

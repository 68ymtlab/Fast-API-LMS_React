...
import { ArrowLeft, Book, ChevronRight, FileText, Home, Settings, ShieldQuestion, Users } from "lucide-react";
                    ...
                    <>
                      ...
                      {paths.length > 3 && (
                        <>
                          ...
                          {paths[3] === 'course' && (
                            <button
                              onClick={() => router.push(`/t/course/${paths[4]}`)}
                              className="flex items-center gap-1 hover:text-gray-700 transition-colors text-gray-800 font-medium"
                            >
                    ...
                    <>
                      ...
                      {paths.length > 3 && (
                        <>
                          ...
                          {paths[3] === 'week' && paths[5] !== 'edit' && (
                            <button
                              onClick={() => router.push(`/t/course/${paths[2]}/week/${paths[4]}`)}
                              className="flex items-center gap-1 hover:text-gray-700 transition-colors text-gray-800 font-medium"
                            >
                              <FileText className="size-4" />
                              週

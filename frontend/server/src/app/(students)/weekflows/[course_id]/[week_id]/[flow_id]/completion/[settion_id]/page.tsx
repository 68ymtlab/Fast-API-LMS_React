...
function FlowCompletionPage() {
	...
	const startNewSession = () => {
		router.push(
			`/weekflows/${params.course_id}/${params.week_id}/${params.flow_id}/session`,
		);
	};
									...
									<div className="grid md:grid-cols-2 gap-6">
										<div className="space-y-4">
											...
											{completionData.total_questions &&
												completionData.correct_answers !== undefined && (
													<div className="text-center text-sm text-gray-600">
														{completionData.correct_answers} /{" "}
														{completionData.total_questions} 問正解
													</div>
												)}
										</div>
							...
							<CardContent className="pt-6">
								<div className="text-center">
									...
									<Button
										...
										onClick={() =>
											router.push(
												`/lesson/${params.course_id}/${params.week_id}/1`,
											)
										}
										className="flex items-center gap-2"
									>

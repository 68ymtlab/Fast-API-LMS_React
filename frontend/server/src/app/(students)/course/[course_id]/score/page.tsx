...
import { AlertCircle, BarChart3, TrendingUp, Target } from "lucide-react";
...
function ScorePage() {
  ...
  const fetchStudentScore = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`/get_flow_session_student_score/${params.course_id}`);
          ...
          {scores.length === 0 ? (
            <Card>
              <CardContent className="text-center py-8">
                ...
                <p className="text-sm text-gray-400 mt-2">演習問題を解いて成績を確認しましょう</p>
              </CardContent>
            </Card>
          ) : (
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm font-medium text-gray-600">平均得点率</CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm font-medium text-gray-600">最高得点率</CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm font-medium text-gray-600">完了した演習数</CardTitle>
                  </CardHeader>
                  <CardContent>

...
import { AlertCircle, BookOpen, Target, Calendar, Hash, Award } from "lucide-react";
...
function SyllabusPage() {
  ...
  const fetchSyllabusInfo = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`/get_syllabus_info/${params.course_id}`);
                    ...
                    <table className="w-full border-collapse border border-gray-300">
                      <thead>
                        <tr className="bg-primary text-white">
                          <th className="border border-gray-300 px-4 py-3 text-center">授業科目区分</th>
                          <th className="border border-gray-300 px-4 py-3 text-center">科目名</th>
                          <th className="border border-gray-300 px-4 py-3 text-center">単位数</th>
                          <th className="border border-gray-300 px-4 py-3 text-center">科目コード</th>
                          <th className="border border-gray-300 px-4 py-3 text-center">開講時期</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr className="bg-white">
                          <td className="border border-gray-300 px-4 py-3 text-center">
                            <Badge variant="outline">{syllabusInfo.subject_class}</Badge>
                          </td>

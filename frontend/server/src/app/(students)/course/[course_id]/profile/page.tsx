...
import { AlertCircle, ChevronDown, ChevronRight, User, Calendar, Target } from "lucide-react";
                                    ...
                                    {Object.entries(weekContent).map(([flowKey, flowContent], flowIndex) => {
                                      ...
                                      return (
                                        <Card key={flowKey} className="ml-4">
                                          <Collapsible 
                                            open={isFlowExpanded} 
                                            onOpenChange={() => toggleFlowExpansion(weekIndex, weekKey, flowIndex, flowKey)}
                                          >
                                            <CollapsibleTrigger className="w-full">
                                              ...
                                              <CardContent className="pt-0">
                                                <div className="space-y-3">
                                                  {flowContent.map((flowSession, sessionIndex) => {
                                                    ...
                                                    return (
                                                      <Card key={sessionIndex} className="ml-4 border-l-4 border-l-blue-200">
                                                        <Collapsible 
                                                        ...
                                                        >
                                                          ...
                                                          >
                                                            <CardHeader className={`py-3 ${!isCompleted && 'hover:bg-gray-50 transition-colors'}`}>
                                                              <div className="flex items-center justify-between">
                                                          ...
                                                          {!isCompleted && (
                                                            <CollapsibleContent>
                                                              <CardContent className="pt-0">
                                                                <h5 className="font-medium mb-3 text-red-600">あなたが間違えた問題</h5>
                                                                <div className="space-y-4">
                                                                  {flowSession.flow_page && Array.isArray(flowSession.flow_page) && flowSession.flow_page.map((flowpage, flowpageIndex) => (
                                                                    <div 
                                                                      key={flowpageIndex}
